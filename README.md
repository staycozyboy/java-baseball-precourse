...
## 기능 구현 리스트
1. 중복되지않는 1 ~ 9 까지 랜덤한 숫자 3개를 만들기
   
2. 플레이어는 3자리 숫자를 입력한다

3. 3자리의 숫자가 유효한지 검사한다.
  - 3자리중에 중복된 숫자가 있으면 예외 발생
  - 숫자가 아닌 문자가 있으면 예외 발생
  - 3자리 숫자가 아닌 경우 예외 발생
  
3. 스트라이크, 볼 카운트
    - 같은 자리, 같은 숫자인 경우 스트라이크 카운트
    - 다른 자리, 같은 숫자인 경우 볼 카운트
  
4. 결과 판단및 흰트제공
    - 볼 스트라이크 순으로 출력하여 힌트 제공
    - 볼 스트라이크가 없으면 "낫싱" 출력
   - 3스트라이크면 게임 종료
